...
window.FANBOX_DICT = {
  ...
  '推荐地址：': 'Recommended URL: ',
  '其他地址：': 'Other URLs: ',
  '复制地址': 'Copy URL',
  '如推荐地址无法访问，请逐个尝试': 'If the recommended URL is unreachable, try the others',
  '未检测到默认网卡；上述地址可能部分不可访问': 'No default network interface detected; some of the URLs above may be unreachable',
  '网卡': 'NIC',
  ...
  '已复制路径': 'Path copied',
  '已复制文件': 'File copied',
  '已复制截图文件': 'Screenshot file copied',
  ...
  '启动 OpenCode：未安装时点击会提示': 'Launch OpenCode: click shows a hint if not installed',
  '启动 Qoder CLI：探测 qoder / qodercli / qoder-cli，未安装时点击会提示': 'Launch Qoder CLI: probes qoder / qodercli / qoder-cli, shows a hint if none are installed',
  'AI Agents': 'AI Agents',
  '重新检测 Agent': 'Re-detect agents',
  '未找到 OpenCode，请先安装并确认 opencode 在 PATH 中。': "OpenCode not found — install it and make sure 'opencode' is on PATH.",
  '未找到 Qoder CLI，请先安装并确认 qoder / qodercli / qoder-cli 在 PATH 中。': "Qoder CLI not found — install it and make sure qoder / qodercli / qoder-cli is on PATH.",
  'OpenCode': 'OpenCode',
  'Qoder CLI': 'Qoder CLI',
  'Qoder': 'Qoder',
